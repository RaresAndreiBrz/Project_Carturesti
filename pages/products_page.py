...
class ProductsPage(BasePage, softest.TestCase):
    ...
    def click_pe_stoc_limitat_sorting(self):
        time.sleep(1)
        stoc_limitat_button = self.driver.find_element(By.XPATH,
                                                       '//*[@id="coloana-filtre"]/filter-form/div/form/div[1]/div/md-checkbox[3]')
        stoc_limitat_button.click()

    def check_if_in_stoc_btn_is_active(self):
        IN_STOC_BTN = self.driver.find_element(By.XPATH,
                                               '//*[@id="coloana-filtre"]/filter-form/div/form/div[1]/div/md-checkbox[2]')
    ...
    def check_if_stoc_limitat_btn_is_active(self):
        STOC_LIMITAT_BTN = self.driver.find_element(By.XPATH,
                                                    '//*[@id="coloana-filtre"]/filter-form/div/form/div[1]/div/md-checkbox[3]')
    ...
    def check_disponibility_sort_buttons(self):
        ...
        self.soft_assert(self.assertTrue(butoane_active_count == 1,f"Expected 1 button active but "
                                                                   f"{butoane_active_count} are active."))
